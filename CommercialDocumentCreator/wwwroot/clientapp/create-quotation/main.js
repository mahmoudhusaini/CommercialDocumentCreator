...
async function inValidateInputField(inputField) {
    ...
    inputField.reportValidity(); // Shows browser validation popup
}
...
createButton.addEventListener('click', (event) => {
    ...
    if (prods.length <= 0) {
        const errorMessage = "Quotation Must Have At Least One Product Item";
...
async function createReceipt(form) {
    ...
    if (response.ok) {
        ...
        commercialDoc.quotationNumber = result.quotationNumber;
        ...
        if (commercialDoc.quotationNumber) {
      ...
      <body>
            ...
            <div class="content-one">
                ...
                <div class="content-one-right">
                    <div class="quotation-nb">${commercialDocObject.type} : ${commercialDocObject.quotationNumber}</div>
                    <div>
                        <h3>Date: </h3>
                    </div>
                    <div>
...
convertSelect.addEventListener('change', (event) => {
    ...
    alertMessageWithCancel.textContent = "Are You Sure You Want To Convert That Quotation";
...
async function convertReceipt(type) {
    ...
    if (response.ok) {
        ...
        convertedDocument.quotationNumber = result.documentNumber;
